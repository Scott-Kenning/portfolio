...
export default function About() {
    return (
        <div className="absolute w-screen flex flex-col items-center justify-center text-left p-10 top-10 md:top-0 max-w-3xl mx-auto">
            <Image src={heroImage} alt="Hero Image" width={200} height={200} className="mb-8 rounded-full shadow shadow-white"/>
            {/* <h2 className="text-4xl font-semibold mx-auto">Hello 👋</h2> */}
            <p className="text-lg">As a passionate developer with a flair for innovation, I thrive on crafting clean and efficient code to bring ideas to life. With a diverse skill set encompassing web and mobile technologies, I enjoy tackling complex challenges and delivering seamless user experiences. Constantly honing my skills and staying up-to-date with the latest trends, I am dedicated to creating cutting-edge solutions that make a positive impact. Lets code the future together!</p>
