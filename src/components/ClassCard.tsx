export const ClassCard = (props: {course: any}) => {
    ...
    return (
        <div className="font-Lato shadow-lg p-4 pt-2 rounded bg-white dark:bg-gray-600 flex flex-col justify-start w-full h-20 overflow-hidden
                        transition-height duration-500 ease-in-out h-16 hover:h-60">
            <h2 className="text-lg">{course.code}</h2>
            <p className="">{course.title}</p>
            <div className="w-100 h-1 bg-gray-500 rounded my-2 flex-shrink-0"></div>
